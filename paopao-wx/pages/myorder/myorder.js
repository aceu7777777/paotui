...
onLoad: function (options) {
  var _this = this
  wx.request({
    url: 'http://101.43.223.7:8080/get-all-my-order/'+'19990523',
    headers: {
    ...
    success: function (res) {
      ...
      wx.request({
        url: 'http://101.43.223.7:8080/get-all-my-server-order/'+'19990523',
        headers: {
          'Content-Type': 'application/json'
        },
        method: 'GET',
  ...
  wx.showModal({
    ...
    success: function (res) {
      if (res.confirm) {
        console.log('点击确认回调')
        wx.request({
          url: 'http://101.43.223.7:8080/change-order-state', 
          data: {
              data:{
